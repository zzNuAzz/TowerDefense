...
public class GameField implements IRender {
    ...
    public void update(long t) {
        ...
        if (healthPoint <= 0) {
            stt = GameStatus.DEFEAT;
            TowerDefense.defeat.setVisible(true);
        }
        if (enemyList_.isEmpty() && enemySpawner.get(enemySpawner.size() - 1).isEmpty()) {
            stt = GameStatus.VICTORY;
            TowerDefense.victory.setVisible(true);
        }
    }
