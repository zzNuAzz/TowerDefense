...
public class MainMenu {
    ...
    public static final String[] level = {"Level/level1.data", "Level/level2.data", "Level/level3.data"};
    ...
    private static Scene InitScene() {
        ...
        tick.setOnMouseClicked(event -> {
            ...
            chooseLevel.setVisible(false);
            TowerDefense.victory.setVisible(false);
            TowerDefense.defeat.setVisible(false);
        });
